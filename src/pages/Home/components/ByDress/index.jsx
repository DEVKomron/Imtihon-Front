    ...
    <div className='container'>
      <div className='dress-wrapper'>
        ...
        <div className='category-tiles'>
          <div className='category-tile' style={{height:"227px"}}>
            <img src="/src/assets/bd1_item.png" style={{width: "100%", height: "100%", objectFit: "contain"}} alt="Casual Style" />
          </div>
          <div className='category-tile' style={{height:"135px"}}>
            <img src="/src/assets/bd2_item.png" style={{width: "100%", height: "100%", objectFit: "contain"}} alt="Formal Style" />
          </div>
          <div className='category-tile'   style={{height:"130px"}}>
            <img src="/src/assets/bd3_item.png" style={{width: "100%", height: "100%" , objectFit: "contain"}} alt="Party Style" />
          </div>
          <div className='category-tile' style={{height:"230px"}}>
            <img src="/src/assets/bd4_item.png" style={{width: "100%", height: "100%", objectFit: "contain"}} alt="Gym Style" />
          </div>
        </div>
      </div>
